...
| Executive Dashboard | Runtime/AI/tenant health | `lib/mission-control`, `lib/stability`, runtime APIs |
| Automation Platform | Workflow registry and analytics | `lib/workflow-os/*` |
