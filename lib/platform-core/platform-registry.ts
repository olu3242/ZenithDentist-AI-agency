...
export const PLATFORM_REGISTRY: PlatformComponent[] = [
  ...
  { id: "workflow_os",        name: "Automation Platform",        version: "1.0.0", layer: "workflow",  status: "active", location: "lib/workflow-os" },
  ...
  { id: "mission_control",    name: "Executive Dashboard",    version: "1.0.0", layer: "application", status: "active", location: "lib/mission-control" },
