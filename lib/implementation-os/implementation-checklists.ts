...
export const IMPLEMENTATION_CHECKLIST: ChecklistItem[] = [
  ...
  { id: "c8",  stage: "workflow_activation",  label: "Recall workflow activated",            required: true,  automatable: true,  verificationMethod: "Automation Platform: recall_due state = executing" },
  { id: "c9",  stage: "workflow_activation",  label: "Review workflow activated",            required: true,  automatable: true,  verificationMethod: "Automation Platform: review_request_due active" },
  { id: "c10", stage: "workflow_activation",  label: "Revenue recovery workflow activated",  required: false, automatable: true,  verificationMethod: "Automation Platform: unpaid_invoice_detected active" },
