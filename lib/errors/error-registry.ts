...
const ERROR_BLUEPRINTS: Partial<Record<ErrorCode, ErrorBlueprint>> = {
  ...
  [ERROR_CODES.RT_WORKFLOW_FAILED]:     { category: "RUNTIME_ERROR",       severity: "critical", messageTemplate: "Workflow execution failed.",                               recoverySuggestion: "Check automation_traces for details. Replay from Executive Dashboard.", recoverable: true, retryable: true },
