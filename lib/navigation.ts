...
export const appNavItems: NavItem[] = [
  ...
  { href: "/mission-control", label: "Executive Dashboard", description: "Super admin automation command center", roles: ["super_admin"], icon: ShieldCheck },
  { href: "/workflow-os", label: "Automation Platform", description: "Registered automations, execution analytics and replay posture", roles: ["super_admin"], icon: Workflow },
