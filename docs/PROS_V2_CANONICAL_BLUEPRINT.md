...
| Operations OS | Automation Platform, Runtime OS, Event Fabric, Executive Dashboard, Automation Center | Workflow/runtime/mission-control routes and modules exist | Partial |
...
- Revenue Recovery System: business outcomes and patient revenue recovery.
- Revenue Playbooks: playbook logic, triggers, metrics, and attribution rules.
- Automation Platform: workflow definition, registration, versioning, and lifecycle state.
...
- Executive Dashboard: operator visibility, runtime health, governance, replay, and support.
...
- Revenue Recovery System is the revenue engine inside PROS.
- Revenue Playbooks are business logic.
- Automation Platform does not own runtime execution.
- Runtime OS owns execution safety.
- ALICE must be grounded through analytics.
- Executive Dashboard must consume analytics, runtime health, workflow health, attribution, and ALICE.
...
- n8n owns outbound delivery, while Automation Platform owns state, evidence, attribution, retries, and governance.
