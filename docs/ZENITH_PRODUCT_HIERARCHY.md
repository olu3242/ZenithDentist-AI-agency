...
### Mission Control™
- **Purpose:** Real-time operational dashboard surfacing workflow health, agent activity, growth score, ALICE recommendations, and communication delivery metrics.
- **Layer:** Experience
- **Owner:** Practice / Zenith Admin
- **Status:** OPERATIONAL
...
### Workflow OS™
- **Purpose:** Canonical execution engine for all platform automation. Every action, journey step, agent task, and delivery is executed through Workflow OS.
- **Layer:** Orchestration
- **Owner:** Workflow OS
- **Status:** OPERATIONAL
...
### AI Agent OS™
- **Purpose:** Seven specialised autonomous agents (Treatment Coordinator, Recall, Membership, Review, Referral, Growth, Compliance) that execute ALICE recommendations through Workflow OS.
- **Layer:** Orchestration
- **Owner:** ALICE / Workflow OS
- **Status:** OPERATIONAL
...
- **Layer:** Application
- **Owner:** Workflow OS / Recall Agent
- **Status:** OPERATIONAL
...
- **Layer:** Application
- **Owner:** Workflow OS / Referral Agent
- **Status:** OPERATIONAL
...
- **Layer:** Application
- **Owner:** Workflow OS / Review Agent
- **Status:** OPERATIONAL
...
- **Layer:** Application
- **Owner:** Workflow OS / Treatment Coordinator Agent
- **Status:** OPERATIONAL
...
| Mission Control™ | workflow_executions, growth_scores, alice_patient_decisions, agent_tasks, integration_health | Practice users | — (read-only dashboard) |
...
| Workflow OS™ | workflow_definitions, workflow_executions, journey_steps, execution_scheduler | All agents, all journey delivery | workflow.execution.started, workflow.execution.completed |
| Integration OS™ | integration_registry, integration_health, external PMS/calendar/payment | Event Fabric, Workflow OS | integration.sync.completed, integration.health.changed |
...
| Recall Engine™ | recall_tracking, appointment_history, patient_profiles | Recall Agent, Workflow OS | recall.triggered, recall.responded, recall.booked |
...
| Treatment Acceptance Engine™ | treatment_plans, patient_influence_scores, alice_patient_decisions | Treatment Coordinator Agent, Workflow OS | treatment.followup.triggered, treatment.accepted |
| Patient Revenue Engine™ | revenue_attribution_records, membership_tracking, recall_tracking, referral_tracking | Command Center, ALICE, forecasting | revenue.snapshot.created, revenue.forecast.updated |
