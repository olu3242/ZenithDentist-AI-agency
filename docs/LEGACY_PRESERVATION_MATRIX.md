...
| Original Dashboard | Expanded | Current portal dashboard and Executive Dashboard exceed legacy scope | `app/portal/dashboard/page.tsx`, `app/mission-control/page.tsx` |
| Original Landing Page | Partial | Revenue promise preserved; PROS/ALICE/Executive Dashboard under-communicated | `app/page.tsx` |
...
| Legacy simple automation engine | Expanded | Automation Platform, Runtime OS, Event Fabric, Executive Dashboard added | `lib/workflow-os`, `lib/runtime` |
