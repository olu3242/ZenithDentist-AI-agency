...
| Settings | Admin | No | Write | Read | Write | Write | No | No | Billing | Read |
| Admin | Admin | No | No | No | No | No | No | No | No | No |

Legend: Admin = full platform control, Write = manage within tenant/role scope, Read = view permitted tenant data, No = blocked.
