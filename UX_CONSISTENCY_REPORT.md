...
- Static prototype pages are not part of the Next app shell and still contain standalone branding.
- Several legacy modules predate the design system and still define local spacing and chart/card styling.
