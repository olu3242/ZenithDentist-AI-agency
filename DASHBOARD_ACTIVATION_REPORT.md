...
Some advanced metrics degrade to empty or generated operational state when Supabase tables are unavailable. This is acceptable graceful degradation, but not full live-only activation.
