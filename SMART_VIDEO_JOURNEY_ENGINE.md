...
Zenith now models patient video journeys as Workflow OS-owned state machines: PMS event -> ALICE classification -> video selection -> delivery callback -> behavioral signal -> next best action -> outcome -> evidence -> attribution.
...
- Mission Control KPIs for sent, viewed, completion, attention, readiness, reviews, referrals, and revenue influence
