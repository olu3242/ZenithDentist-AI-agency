...
- Several Executive Dashboard panels with inline executive dark-surface hex values
...
Keep current brand system as canonical. Add `lib/theme.ts` and migrate remaining hardcoded hex styles in Executive Dashboard, OG image, report exports, and static prototype assets in a future cleanup pass.
