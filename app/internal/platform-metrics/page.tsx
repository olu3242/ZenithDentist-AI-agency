  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <MetricCard label="Platform health" value={platformHealth} detail="Composite internal score" tone="teal" />
        <MetricCard label="Active orgs" value={activeOrganizations} detail="Tenant-ready architecture" tone="blue" />
        <MetricCard label="Automation events" value={portalData.automationEvents.length} detail="Event-driven operating layer" tone="gold" />
      </div>
