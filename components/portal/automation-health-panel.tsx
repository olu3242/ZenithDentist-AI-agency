  ...
  return (
    <section className="rounded border border-line bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between gap-4">
        ...
        <strong className="text-2xl text-teal">{successRate}%</strong>
      </div>
      <div className="mt-5 grid gap-3 md:grid-cols-5">
        {activeSystems.map(system => {
          ...
          return (
            <div key={system} className="rounded bg-paper p-3">
              <div className={healthy ? "text-green" : "text-rust"}>
      ...
      <div className="mt-5 rounded bg-teal/10 p-4 text-sm font-bold text-teal">
