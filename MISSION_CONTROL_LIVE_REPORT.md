# Executive Dashboard Live Report

## Live Ops Sources

- Runtime health: `automation_traces`, `automation_dead_letters`
- Workflow health: Automation Platform runtime state
...
- Dashboard and Automation Platform now surface persisted automation registry state.

## Remaining Gap

Executive Dashboard command widgets are still mostly read/observe oriented. Additional command APIs are needed for full recovery orchestration from the UI.
